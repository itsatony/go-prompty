...
[![Version](https://img.shields.io/badge/version-2.11.0-blue.svg)](https://github.com/itsatony/go-prompty/releases/tag/v2.11.0)
...
| **A2A Agent Cards** | Generate Google A2A protocol Agent Cards from Prompt configuration |
